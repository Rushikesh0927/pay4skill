  ...
  const [chatThreads, setChatThreads] = useState<ChatThread[]>([
    {
      ...
      lastMessage: 'I can start working on the project next week.',
      ...
      messages: [
        ...
        },
        {
          id: '4',
          sender: 'student',
          content: 'I can start working on the project next week.',
          timestamp: '11:30 AM',
        },
      ],
    },
    {
      ...
      lastMessage: 'I have completed the initial design mockups.',
      ...
      messages: [
        {
          id: '1',
          sender: 'student',
          content: 'I have completed the initial design mockups.',
          timestamp: 'Yesterday',
        },
      ],
    },
          ...
          <CardContent className="p-4">
            <div className="space-y-2">
              {chatThreads.map((thread) => (
                ...
                >
                  <Avatar>
                    <AvatarImage src={thread.studentAvatar} />
                  ...
                  {chatThreads
                    ...
                    ?.messages.map((message) => (
                      <div
                        key={message.id}
                        className={`flex ${
                          message.sender === 'employer' ? 'justify-end' : 'justify-start'
                        }`}
                      >
                        <div
